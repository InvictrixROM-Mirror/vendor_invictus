...
tar xfp "vendor/invictus/bootanimation/bootanimation.tar" -C "$BOOTANIOUT/bootanimation/"
...
cat "vendor/invictus/bootanimation/desc.txt" >> "$BOOTANIOUT/bootanimation/desc.txt"
