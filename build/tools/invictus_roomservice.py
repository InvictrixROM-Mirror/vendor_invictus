...
custom_dependencies = "invictus.dependencies"
org_manifest = "InvictusRom-Devices"  # leave empty if org is provided in manifest
org_display = "InvictusRom-Devices"  # needed for displaying
